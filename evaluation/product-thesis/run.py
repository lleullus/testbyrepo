...
def _preclose_thesis(store: ArtifactStore, project: Path, thesis: Path) -> dict:
    ...
    LIFECYCLE.complete_review(store, source_review, result={"completion": "COMPLETE", "fixture": "synthetic precondition", "model_invoked": False})
    ...
    LIFECYCLE.complete_review(store, candidate_review, result={"completion": "COMPLETE", "fixture": "synthetic precondition", "model_invoked": False}, findings=[])
