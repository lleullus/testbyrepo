...
- In MCP `consult`, use `preset: "chatgpt-pro-heavy"` for ChatGPT browser mode with `gpt-5.5-pro` and maximum Pro effort. Add `dryRun: true` to inspect the resolved run without creating a session or touching Chrome.
...
| `--browser-thinking-time <light\|standard\|extended\|heavy\|pro>`              | Set ChatGPT thinking-time intensity (browser; modern UI: Instant, Medium, High, Extra High, Pro).                                                                                                                                                                                                                                         |
