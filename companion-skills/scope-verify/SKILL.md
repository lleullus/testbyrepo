---
name: scope-verify
description: "Verify one exact ready IIS Scope against a stable current implementation target, adjudicating every authored Acceptance scenario and product success condition from fresh discriminating evidence. Exactly one independent verifier owns each semantic cycle; successful verification is followed by caller-owned read-only Coverage before completion recording."
---
