...
- Browser: support the modern five-tier ChatGPT Effort menu, including explicit `pro`, exact Extra High/Pro selection without changing the current model, and fail-closed model-mutation detection.
