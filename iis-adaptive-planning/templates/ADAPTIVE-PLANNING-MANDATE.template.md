...
Applies-To: <bounded initiative / scope slug / work context>

## Desired Product Outcome

<durable user/operator result this planning should move toward>
...
1. <highest-priority judgment criterion>
2. <next criterion>
...
<concise current user instruction/adopted mandate basis; do not fabricate a direct quote>
